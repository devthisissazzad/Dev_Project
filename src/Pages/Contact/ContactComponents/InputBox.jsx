...
const InputBox = ({ textarea = false, required = false, heading, className, ...props }) => {
    const inputClassName = `lg:py-6 py-4 pl-8 placeholder:font-inter placeholder:font-regular placeholder:text-[#A1A1A1]
	...
	return (
		<Flex className={"w-full flex-col gap-4"}>
			<h3 className='font-inter font-semibold text-dark2 text-lg lg:text-xl'>
